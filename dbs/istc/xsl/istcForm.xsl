					...
					<div id="refcontainer"><strong>References:</strong><br/>				
						<div id="referencestable" class="tablecontainer">
							<table id="table_references"><tbody>
								<tr><td class="melabel">Reference:</td><td> <input type="text" onfocus="setCurrent(this);" onkeyup="suggest(this.id, event);" autocomplete="off" name="references" id="510_a" class="tablewidthwithlabel"></input><br/></td></tr>
						   		<tr><td class="melabel">Other Details:</td><td> <input type="text" onfocus="setCurrent(this);" name="refpages" id="510_c" autocomplete="off" class="tablewidthwithlabel"/></td></tr>
						    	<tr></tr>
						    </tbody></table>
						</div>
					</div><br/>
					...
					<div id="holdingscontainer"><strong>Holdings:</strong><br />
						<div id="holdingstable" class="tablecontainer">
							<table id="table_holdings"><tbody>
								<tr><td class="melabel">Country:</td><td><select name="holdings" id="holdings_country" onchange="javascript: checkUSA();"><option value="951">British Isles</option><option value="995">Belgium</option><option value="957">France</option><option value="997">Germany</option><option value="954">Italy</option><option value="955">Spain/Portugal</option><option value="996">Netherlands</option><option value="993">Austria</option><option value="952">U.S.A.</option><option value="958">Other Europe</option><option value="953">Other</option><option value="994">Doubtful</option></select></td></tr>
								<tr><td class="melabel">Library:</td><td><input type="text" onfocus="setCurrent(this);" onkeyup="suggest(this.id, event);" autocomplete="off" name="holdings" id="holdings_a" class="tablewidthwithlabel"></input><br/></td></tr>
								<tr><td class="melabel">Details:</td><td><input type="text" onfocus="setCurrent(this);" autocomplete="off" name="holdings" id="holdings_b" class="tablewidthwithlabel"></input></td></tr>
