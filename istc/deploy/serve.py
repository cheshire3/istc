"""Start a demo server to expose ISTC databases via SRU etc.

Start an HTTP server to expose ISTC databases via web, SRU, OAI-PMH (and
maybe more in future) protocols for development and demonstration purposes.
